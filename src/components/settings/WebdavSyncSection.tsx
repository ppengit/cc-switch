...
export function WebdavSyncSection({
  ...
  const currentRemotePath = `/${form.remoteRoot.trim() || "cc-switch-sync"}/v2/db-v8/${form.profile.trim() || "default"}`;
  const currentS3RemotePath = `${s3Bucket.trim() || "bucket"}/${s3RemoteRoot.trim() || "cc-switch-sync"}/v2/db-v8/${s3Profile.trim() || "default"}`;
