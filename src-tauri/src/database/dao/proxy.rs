...
mod tests {
    ...
    #[tokio::test]
    async fn set_proxy_flags_sync_clears_auto_failover_when_takeover_is_off() -> Result<(), AppError>
    {
        let db = Database::memory()?;
    ...
    #[tokio::test]
    async fn update_proxy_config_for_app_sanitizes_auto_failover_invariants() -> Result<(), AppError>
    {
        let db = Database::memory()?;
