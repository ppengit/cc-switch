...
/// Example: `cc-switch-sync/v2/db-v10/default/manifest.json`
...
mod tests {
    ...
    fn s3_key_uses_v2_and_correct_format() {
        ...
        assert_eq!(key, "cc-switch-sync/v2/db-v10/default/manifest.json");
    }
    ...
    fn s3_key_with_custom_profile() {
        ...
        assert_eq!(s3_key(&settings, "db.sql"), "my-root/v2/db-v10/work/db.sql");
    }
