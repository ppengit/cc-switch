...
///  first_token_ms, duration_ms, status_code, error_message, session_id,
///  provider_type, created_at, data_source, pricing_model, input_token_semantics`
///
    ...
    pub fn get_request_logs(
        ...
        let sql = format!(
            "SELECT l.request_id, l.provider_id, {logs_pname} as provider_name, l.app_type, l.model,
                    ...
                    l.status_code, l.error_message, l.session_id, l.provider_type, l.created_at, l.data_source, l.pricing_model,
        ...
        for log in &mut logs {
            Self::maybe_backfill_log_costs(&conn, log, &mut pricing_cache)?;
        }
    ...
    pub fn get_request_detail(
        ...
        let detail_sql = format!(
            "SELECT l.request_id, l.provider_id, {detail_pname} as provider_name, l.app_type, l.model,
                    ...
                    status_code, error_message, l.session_id, l.provider_type, created_at, l.data_source, l.pricing_model,
                    l.input_token_semantics
             FROM proxy_request_logs l
             LEFT JOIN providers p ON l.provider_id = p.id AND l.app_type = p.app_type
             WHERE l.request_id = ?"
    ...
    pub(crate) fn backfill_missing_usage_costs_on_conn(
        ...
        const BASE_SQL: &str =
            "SELECT request_id, provider_id, NULL AS provider_name, app_type, model, request_model,
                        ...
                        session_id, provider_type, created_at, data_source, pricing_model,
