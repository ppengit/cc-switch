...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_session_routing_master_enabled,
            commands::set_session_routing_master_enabled,
            commands::list_session_provider_bindings,
            commands::get_session_provider_binding,
            commands::switch_session_provider_binding,
            commands::set_session_provider_binding_pin,
            commands::remove_session_provider_binding,
            commands::get_provider_session_occupancy,
