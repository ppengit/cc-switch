...
mod tests {
    ...
    mod anchored_upgrade_windows {
        ...
        #[test]
        fn codex_windows_no_sibling_has_no_anchored_update() {
            // Codex self-update can report success while leaving optional platform binaries broken.
            // Without a sibling package manager we intentionally fall back to the static command.
