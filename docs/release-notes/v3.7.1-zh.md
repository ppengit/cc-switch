...
访问 [Releases](https://github.com/ppengit/cc-switch/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/ppengit/cc-switch/releases/latest) 下载：
...
- **问题反馈**：[GitHub Issues](https://github.com/ppengit/cc-switch/issues)
- **讨论**：[GitHub Discussions](https://github.com/ppengit/cc-switch/discussions)
