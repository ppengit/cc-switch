...
Visit [Releases](https://github.com/ppengit/cc-switch/releases/latest) to download the latest version
...
Visit [Releases](https://github.com/ppengit/cc-switch/releases/latest) to download:
...
- **Issues**: [GitHub Issues](https://github.com/ppengit/cc-switch/issues)
- **Discussions**: [GitHub Discussions](https://github.com/ppengit/cc-switch/discussions)
